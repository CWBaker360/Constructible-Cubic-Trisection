...
A citation file is included at [`CITATION.cff`](CITATION.cff). GitHub will use this file to show a “Cite this repository” button.

## License

No final license has been selected in this starter package. See [`LICENSE_NOTICE.md`](LICENSE_NOTICE.md) before making the repository public.
